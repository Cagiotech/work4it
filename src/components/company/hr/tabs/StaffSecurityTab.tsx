...
export function StaffSecurityTab({
  ...
  const handleCreateAccount = async () => {
    if (!staffEmail) {
      toast.error("O colaborador precisa ter um email definido");
      return;
    }
    ...
    try {
      console.log("Creating staff account:", { staffId, staffEmail, staffName });
      ...
      console.log("Create account response:", data, error);
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Para criar uma conta de acesso, primeiro é necessário definir um email para este colaborador
                  na aba de Perfil.
                </p>
              </div>
            </div>
