...
import { Search, Dumbbell, Users, ArrowLeft, ChevronRight } from "lucide-react";
...
export default function PersonalTrainingPlans() {
  ...
  // If a student is selected, show their training plans
  if (selectedStudent) {
    return (
      <div className="space-y-4 md:space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold tracking-tight">
                Planos de Treino - {selectedStudent.full_name}
              </h1>
              <p className="text-muted-foreground text-sm">
                Criar e gerir planos de treino para este aluno
              </p>
            </div>
          </div>
        </div>

        <StudentTrainingTab studentId={selectedStudent.id} canEdit={true} />
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm md:text-base">
            Selecione um aluno para gerir os seus planos de treino
          </p>
        </div>
